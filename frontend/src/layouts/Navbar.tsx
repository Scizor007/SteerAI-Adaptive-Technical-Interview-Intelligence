...
export function Navbar({ fullBleed = false }: NavbarProps) {
  ...
  return (
    <header className="sticky top-0 z-50 border-b border-border/80 bg-bg-primary/80 backdrop-blur-xl">
      <div className={fullBleed ? 'mx-auto flex h-16 w-full max-w-[1600px] items-center justify-between px-6 md:px-12 lg:px-20 xl:px-24' : 'container-steer flex h-16 items-center justify-between'}>
